...
var FileService = /** @class */ (function () {
    ...
    FileService.prototype.uploadFile = function (file, folderName) {
        return __awaiter(this, void 0, void 0, function () {
            var extension, fileKey, params;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        extension = path.extname(file.originalname);
                        fileKey = "" + Date.now() + extension;
                        params = {
                        ...
                        return [4 /*yield*/, this.s3Client.send(new client_s3_1.PutObjectCommand(params))];
                    case 1:
                        _a.sent();
                        // return `https://${this.bucketName}.s3.amazonaws.com/${folderName}/${fileKey}`;
                        return [2 /*return*/, folderName + "/" + fileKey];
                }
            });
        });
    };
