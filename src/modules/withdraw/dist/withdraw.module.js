...
var WithdrawModule = /** @class */ (function () {
    ...
    WithdrawModule = __decorate([
        common_1.Module({
            imports: [typeorm_1.TypeOrmModule.forFeature([withdrawByBanks_entity_1.WithdrawByBankss, withdraw_entity_1.Withdraw]), pinCode_module_1.PinCodeModule, user_module_1.UserModule, notfication_module_1.NotficatioModule, userWallte_module_1.UserWaalteModule],
